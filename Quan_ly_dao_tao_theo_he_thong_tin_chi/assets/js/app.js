...
function create_user() {
    ...
    cell4.innerHTML = '<i class="nc-icon nc-ruler-pencil"></i>';
    cell5.innerHTML = `<span onclick="delete_user(this)"><i class=" nc-icon nc-simple-remove"></i><span>`;
...
function read_data() {
    ...
    cell4.innerHTML = `<span onclick="edit_user(this)"><i class="nc-icon nc-ruler-pencil"></i><span>`;
    cell5.innerHTML = `<span onclick="delete_user(this)"><i class=" nc-icon nc-simple-remove"></i><span>`;
